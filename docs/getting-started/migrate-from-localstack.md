...
| `SERVICES` | _(not needed)_ | Floci starts every service instantly; no selection required |
...
| Service selection | `SERVICES=sqs,s3,...` | All services start automatically; no selection |
